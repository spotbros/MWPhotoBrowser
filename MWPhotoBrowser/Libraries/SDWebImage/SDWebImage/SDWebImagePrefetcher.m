...
- (void)reportStatus
{
    ...
    NSLog(@"Finished prefetching (%d successful, %lu skipped, timeElasped %.2f)", (int)total - (int)self.skippedCount, (unsigned long)self.skippedCount, CFAbsoluteTimeGetCurrent() - self.startedTime);
}
